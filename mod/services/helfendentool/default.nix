...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    teenix.services.helfendentool.settings = {
      ...
      authentication = {
        ...
        oidc = {
          ...
          provider = {
            authorization_endpoint = "${config.teenix.services.authentik.hostname}/application/o/authorize/";
            token_endpoint = "${config.teenix.services.authentik.hostname}/application/o/token/";
            user_endpoint = "${config.teenix.services.authentik.hostname}/application/o/userinfo/";
            jwks_uri = "${config.teenix.services.authentik.hostname}/application/o/helfertool/jwks/";
            ...
            logout = {
              endpoint = "${config.teenix.services.authentik.hostname}/application/o/helfertool/end-session/";
    ...
    sops.templates.helfendentool-rabbitmq.content = ''
